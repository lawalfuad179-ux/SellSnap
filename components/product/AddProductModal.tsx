      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-16)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            <label htmlFor="modal-description" style={{ fontSize: 'var(--font-label-medium-font-size)', fontWeight: 'var(--font-label-medium-font-weight)', color: 'var(--color-on-surface)' }}>
              Description
            </label>
            <textarea
