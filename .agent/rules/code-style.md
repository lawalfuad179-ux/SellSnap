...
CSS Modules with design tokens. No inline styles, no Tailwind, no styled-components. If a pattern repeats, extract it into a component, not a custom class.

Use design tokens from `tokens/design-tokens.css` for all colors and typography.
